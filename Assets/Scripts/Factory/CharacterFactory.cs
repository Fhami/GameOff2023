...
namespace DefaultNamespace
{
    ...
    public static class CharacterFactory
    {
        public static RuntimeCharacter Create(string name)
        {
            ...
            runtimeCharacter.properties.Add(PropertyKey.STABLE, new Property<int>(0));
            runtimeCharacter.properties.Add(PropertyKey.THORNS, new Property<int>(0));
            runtimeCharacter.properties.Add(PropertyKey.DECAY, new Property<int>(0));
            runtimeCharacter.properties.Add(PropertyKey.GROW, new Property<int>(0));
            runtimeCharacter.properties.Add(PropertyKey.UNSTABLE, new Property<int>(0));

...
namespace DefaultNamespace
{
    ...
    public static class CharacterFactory
    {
        public static RuntimeCharacter Create(string name)
        {
            ...
            runtimeCharacter.properties.Add(PropertyKey.ARMOR, new Property<int>(0, PropertyKey.ARMOR));
            runtimeCharacter.properties.Add(PropertyKey.SHIELD_DOWN, new Property<int>(0, PropertyKey.SHIELD_DOWN));
            runtimeCharacter.properties.Add(PropertyKey.SHIELD_UP, new Property<int>(0, PropertyKey.SHIELD_UP));
            runtimeCharacter.properties.Add(PropertyKey.ENVENOMED, new Property<int>(0, PropertyKey.ENVENOMED));
            runtimeCharacter.properties.Add(PropertyKey.FRAGILE, new Property<int>(0, PropertyKey.FRAGILE));
            runtimeCharacter.properties.Add(PropertyKey.INTEGRITY, new Property<int>(0, PropertyKey.INTEGRITY));
            runtimeCharacter.properties.Add(PropertyKey.NUTRIENT, new Property<int>(0, PropertyKey.NUTRIENT));
            runtimeCharacter.properties.Add(PropertyKey.PROTECTION, new Property<int>(0, PropertyKey.PROTECTION));
            runtimeCharacter.properties.Add(PropertyKey.REGEN, new Property<int>(0, PropertyKey.REGEN));
            runtimeCharacter.properties.Add(PropertyKey.REPEL, new Property<int>(0, PropertyKey.REPEL));
            runtimeCharacter.properties.Add(PropertyKey.STABLE, new Property<int>(0, PropertyKey.STABLE));
            runtimeCharacter.properties.Add(PropertyKey.STRENGTH_DOWN, new Property<int>(0, PropertyKey.STRENGTH_DOWN));

	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult116 = dot( tex2D( _DissolveMask, ( float4( rotator94, 0.0 , 0.0 ) + float4( ( _TimeParameters.x * _DissolveMaskPanSpeed ), 0.0 , 0.0 ) + uvs4_DissolveMask.w + Distortion192 + appendResult206 ).xy ) , _DissolveMaskChannel );
				...
				float3 temp_output_39_0 = ( (tex2D( _GradientMap, temp_cast_10 )).rgb * (IN.ase_color).rgb * (tex2D( _ColorTexture, ( rotator173 + uv2_ColorTexture + Distortion192 ) )).rgb );
				...
				float dotResult115 = dot( tex2D( _Texture, ( rotator53 + uv2_Texture + Distortion192 ) ) , _TextureChannel );
...
/*ASEBEGIN
Version=18900
42;781;1378;782;1531.88;1139.614;3.817133;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;181;-4953.408,1559.338;Inherit;True;Property;_DistortMask;Distort Mask;17;1;[Header];Create;True;1;Distort Mask;0;0;False;0;False;None;8ec3d021bc00d864ca7f675c31983b04;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;208;-4381.07,1524.182;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RadiansOpNode;184;-4568.237,1917.884;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;207;-4077.408,1532.212;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;189;-4337.595,1943.991;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;190;-3855.931,1895.344;Inherit;False;4;4;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;63;-4603.757,319.5667;Inherit;True;Property;_DissolveMask;Dissolve Mask;7;1;[Header];Create;True;1;Dissolve Mask;0;0;False;0;False;None;8ec3d021bc00d864ca7f675c31983b04;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;203;-4136.005,379.6735;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;206;-3832.343,387.7035;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-3872.455,-963.0154;Inherit;True;Property;_Texture;Texture;0;1;[Header];Create;True;1;Main Alpha;0;0;False;0;False;None;a162ba453bdc63b42ad74fec219fcd04;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;77;-2881.057,30.75589;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;102;149.7728,384.3555;Inherit;False;Property;_AlphaBoldness;Alpha Boldness;35;0;Create;True;0;0;0;False;0;False;1;2.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;240;347.042,1230.823;Inherit;False;Property;_DepthFadeDivide;Depth Fade Divide;38;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;639.892,1026.816;Inherit;False;Property;_UseDepthFade;Use Depth Fade;37;1;[Header];Create;True;1;Depth Fade;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RoundOpNode;228;514.4946,434.6829;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;230;652.5856,490.0969;Inherit;False;Property;_FlatAlpha;Flat Alpha;36;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;2602.372,-433.9586;Inherit;False;Property;_ZWrite;ZWrite;40;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;24;24.60729,-784.7709;Inherit;True;Property;_GradientMap;Gradient Map;27;1;[Header];Create;True;1;Gradient Map;0;0;False;0;False;None;06aa3646e7a5d454db424b66c9a08747;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;159;2090.372,-433.9586;Inherit;False;Property;_Src;Src;42;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;2856.372,-435.9586;Inherit;False;Property;_ZTest;ZTest;41;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;2346.372,-433.9586;Inherit;False;Property;_Dst;Dst;43;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;1843.115,-476.3185;Inherit;False;Property;_Cull;Cull;39;1;[Header];Create;True;1;Rendering;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;1491.387,66.19839;Inherit;False;Property;_Brightness;Brightness;34;1;[Header];Create;True;1;Brightness and Opacity;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;13;-3025.837,-1592.447;Inherit;True;Property;_GradientShape;Gradient Shape;24;1;[Header];Create;True;1;Gradient Shape;0;0;False;0;False;None;50cc1d5a898307440b22da0fc205e5c2;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=535CD32D670EA1AF8CA21855C91EEAA375411257
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult114 = dot( tex2D( _GradientShape, ( rotator164 + uv2_GradientShape + Distortion202 ) ) , _GradientShapeChannel );
				...
				float4 appendResult209 = (float4(uv2s4_DissolveMask.z , uv2s4_DissolveMask.w , 0.0 , 0.0));
				float dotResult116 = dot( tex2D( _DissolveMask, ( float4( rotator94, 0.0 , 0.0 ) + float4( ( _TimeParameters.x * _DissolveMaskPanSpeed ), 0.0 , 0.0 ) + uvs4_DissolveMask.w + Distortion202 + appendResult209 ).xy ) , _DissolveMaskChannel );
				...
				float3 temp_output_39_0 = ( (tex2D( _GradientMap, temp_cast_10 )).rgb * (IN.ase_color).rgb * (tex2D( _ColorTexture, ( rotator172 + uv2_ColorTexture ) )).rgb );
				...
				float dotResult115 = dot( tex2D( _Texture, ( rotator53 + uv2_Texture + Distortion202 ) ) , _TextureChannel );
				...
				float temp_output_78_0 = ( saturate( dotResult115 ) * temp_output_74_0 * AdditionalAlpha263 );
				float temp_output_118_0 = ( pow( temp_output_78_0 , _CorePower ) * _CoreIntensity );
				float4 lerpResult124 = lerp( float4( temp_output_39_0 , 0.0 ) , _CoreColor , temp_output_118_0);
				float4 lerpResult127 = lerp( float4( temp_output_39_0 , 0.0 ) , saturate( lerpResult124 ) , _DifferentCoreColor);
				float temp_output_277_0 = ( saturate( ( temp_output_78_0 + temp_output_118_0 ) ) * _AlphaBoldness );
...
/*ASEBEGIN
Version=18900
471;90;1411;722;897.7901;112.589;1.3;True;False
Node;AmplifyShaderEditor.WorldSpaceCameraPos;220;1705.204,751.3154;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;219;1699.204,523.3154;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TextureCoordinatesNode;221;2030.557,630.7706;Inherit;False;2;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;222;2071.358,473.4951;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;223;2319.358,429.4951;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;208;-4124.618,367.927;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;257;-4451.469,2253.693;Inherit;True;Property;_StaticAlphaTexture;Static Alpha Texture;3;1;[Header];Create;True;1;Static Alpha;0;0;False;0;False;None;1c2038dff1550724e981c0534a78a837;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;189;-3823.955,1404.205;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;226;102.6457,484.7787;Inherit;False;Property;_FlatAlpha;Flat Alpha;36;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;192;-3780.481,1824.014;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;24;31.4227,-870.5547;Inherit;True;Property;_GradientMap;Gradient Map;27;1;[Header];Create;True;1;Gradient Map;0;0;False;0;False;None;87ea83079116cb74181b4374014d5fe3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.GetLocalVarNode;205;-2421.22,-1009.844;Inherit;False;202;Distortion;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;274;2270.693,-1337.566;Inherit;False;Property;_ZTest;ZTest;41;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-4801.751,233.2988;Inherit;False;Property;_MoveWithTexture;Move With Texture;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-1245.751,518.1982;Inherit;False;Property;_CoreIntensity;Core Intensity;31;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;664.975,821.4844;Inherit;False;Property;_DepthFadeDivide;Depth Fade Divide;38;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;63;-4603.757,321.5667;Inherit;True;Property;_DissolveMask;Dissolve Mask;7;0;Create;True;0;0;0;False;0;False;None;752976eb10633414d82b1a186c6368ce;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;137;-3516.841,-532.495;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;228;957.8249,617.4774;Inherit;False;Property;_UseDepthFade;Use Depth Fade;37;1;[Header];Create;True;1;Depth Fade;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RadiansOpNode;162;-2557.292,-1210.671;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;196;-3298.816,1775.367;Inherit;False;4;4;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;123;800.04,-244.9492;Inherit;False;Property;_CoreColor;Core Color;33;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;271;1760.693,-1335.566;Inherit;False;Property;_Dst;Dst;43;0;Create;True;0;0;0;True;0;False;5;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;83;-3529.561,606.7538;Inherit;False;5;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;195;-3520.293,1412.235;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;138;-4703.844,110.3896;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;273;2016.693,-1335.566;Inherit;False;Property;_ZWrite;ZWrite;40;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;130;-5023.846,-353.6102;Inherit;True;Property;_DissolveDirection;Dissolve Direction;12;1;[Header];Create;True;1;Dissolve Direction;0;0;False;0;False;None;c7d444ccb91271249b360dd9e40d5658;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.DynamicAppendNode;209;-3820.956,378.7203;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;104;-1245.751,390.1981;Inherit;False;Property;_CorePower;Core Power;30;1;[Header];Create;True;1;Different Center Color;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;125;1357.696,-126.8626;Inherit;False;Property;_DifferentCoreColor;Different Core Color;32;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;77;-2884.232,33.93114;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-3872.455,-963.0154;Inherit;True;Property;_Texture;Texture;0;1;[Header];Create;True;1;Main Alpha;0;0;False;0;False;None;1c2038dff1550724e981c0534a78a837;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;185;-4274.326,1775.445;Inherit;False;Property;_DistortMaskRotation;Distort Mask Rotation;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;272;1504.693,-1335.566;Inherit;False;Property;_Src;Src;42;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;276;-437.9239,23.63118;Inherit;False;Property;_AlphaBoldness;Alpha Boldness;35;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;146;-3171.228,-335.5703;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;270;1257.436,-1375.926;Inherit;False;Property;_Cull;Cull;39;1;[Header];Create;True;1;Rendering;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;212;-4456.751,123.4988;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;1421.83,54.60567;Inherit;False;Property;_Brightness;Brightness;34;1;[Header];Create;True;1;Brightness and Opacity;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;225;287.4967,283.9659;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;13;-2929.389,-1599.491;Inherit;True;Property;_GradientShape;Gradient Shape;24;1;[Header];Create;True;1;Gradient Shape;0;0;False;0;False;None;1c2038dff1550724e981c0534a78a837;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;177;2519.028,-75.02066;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;/_Kass_/SH_VFX_PanDissolveAdd;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;2;True;270;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;True;True;4;1;True;272;1;True;271;3;1;True;272;10;True;271;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;273;True;3;True;274;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;wiiu;0;0;Standard;22;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;DOTS Instancing;0;Meta Pass;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=C9BA090AFC2F5B108E9B4999AE5FD4DDF34B9A25